...
<td width="80">&nbsp;</td>
      <td width="455"><center><img src="img/logo-login-aak.png" alt="Target Admin" width="30%"></center></div>
        <div class="account-body">
          ...
          <form class="form account-form" method="POST" action="proses-registerwk.php">         
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><input type="text" class="form-control" placeholder="Username" name="txtUsername"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><label class="col-md-2">Kelas</label></td>
      <td><input type="text" class="form-control" placeholder="Nama Kelas" name="txtKelas"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
