 ...
 <div class="content-header">
   ...
   <div class="content-header">
  <a href='?loadPage=mahasiswa&action=input'><button type='button' class='btn btn-info '>Tambah Data</button></a>
      </div> <!-- /.content-header -->
          ...
          <div class="portlet">
            ...
            <div class="portlet-content">           
              ...
              >
                  ...
                  <tbody>
                    <?php
				  $_SQL=mysql_query("SELECT * FROM tmahasiswa ORDER BY username ASC");
				  $no=1;
				  ...
				  echo"
					  ...
					  echo"
					  	  ...
					  	  <td>
					  <a href='?loadPage=mahasiswa&action=edit&id=$_data[kdMahasiswa]'><button type='button' class='btn btn-success btn-sm'>Edit</button></a>";
					  if(isset($_data['foto'])){
						  echo"<a href='$loadModule?loadPage=mahasiswa&action=hapusData&id=$_data[kdMahasiswa]&fimage=$_data[foto]'><button type='button' class='btn btn-danger btn-sm'>Hapus</button></a>
					  ";
						  }else{
							echo"
							<a href='$loadModule?loadPage=mahasiswa&action=hapusData&id=$_data[kdMahasiswa]'><button type='button' class='btn btn-danger btn-sm'>Hapus</button></a>
