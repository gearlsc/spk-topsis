 <div class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="?loadPage=mahasiswa">Pengguna</a></li>
...
<div class="portlet">
        ...
        <div class="portlet-content">
          ...
          <form class="form-horizontal" role="form" method="post" action="data/mahasiswa/proses.php?loadPage=mahasiswa&action=simpanData" enctype="multipart/form-data">
